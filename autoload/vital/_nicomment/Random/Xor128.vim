...
execute join(['function! vital#_nicomment#Random#Xor128#import() abort', printf("return map({'srand': '', '_vital_depends': '', 'new_generator': '', 'rand': '', '_vital_loaded': ''}, \"vital#_nicomment#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
